...
public class QueryBuilder {
    ...
    public static RealmResults<Launch> buildSwitchQueryAsync(Realm realm) {

        Date date = new Date();

        RealmQuery<Launch> query = realm.where(Launch.class).greaterThanOrEqualTo("net", date).findAll().where();
        query = query.equalTo("location.isSubscribed", true)
                .or()
    ...
    public static RealmResults<Launch> buildSwitchQuery(Realm realm) {
        Date date = new Date();
    ...
    public static RealmResults<Launch> buildSwitchQuery(Context context, Realm realm, boolean calendarState) {
        ...
        RealmQuery<Launch> query = realm.where(Launch.class)
                .greaterThanOrEqualTo("net", date).equalTo("syncCalendar", calendarState).beginGroup();
